...
(
    MaKHDT VARCHAR(50) NOT NULL,
    MoTa NVARCHAR(200),
    NgayDieuTri DATE,
    GhiChu NVARCHAR(200), 
    TrangThai VARCHAR(10), -- yellow | blue | green
    Gia INT,
    LieuTrinh VARCHAR(50),
    NhaSi VARCHAR(50),
    TroLy VARCHAR(50),
    BenhNhan VARCHAR(50),
